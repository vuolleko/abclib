...
xx, yy = abclib.abc_bolfi(simu, obs, init_x, n_eval, limits_min, limits_max,
                          ...
                          hp_learn_interval=31, sigma_jitter=0.2)
...
ax1.semilogy(xx[:n_init, 1], yy[:n_init], 'xr', label='Initial samples $\sigma$')
ax1.semilogy(xx[n_init:, 1], yy[n_init:], 'xb', label='Based on acquisition function $\sigma$')
